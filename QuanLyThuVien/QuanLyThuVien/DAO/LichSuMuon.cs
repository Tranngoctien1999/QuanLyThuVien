...
namespace DAO
{
    public class LichSuMuon:KetNoi
    {
        ...
        {
            string sqlString = string.Format("select TenSach,TheLoai,TacGia,NhaXuatBan,NgayTra from PHIEUTRA, SACH, ACCOUNT where PHIEUTRA.MaDocGia = ACCOUNT.MaDocGia and SACH.MaSach = PHIEUTRA.MaSach and ACCOUNT.TenDangNhap = '{0}'", _tdn);
            return GetData(sqlString);
        }
        public DataTable Search(string _ts, string _tdn)
        {
            string sqlString = string.Format("select TenSach,TheLoai,TacGia,NhaXuatBan,NgayTra from PHIEUTRA, SACH, ACCOUNT where PHIEUTRA.MaDocGia = ACCOUNT.MaDocGia and SACH.MaSach = PHIEUTRA.MaSach and ACCOUNT.TenDangNhap = '{0}' and SACH.TenSach like N'%{1}%'", _tdn, _ts);
            return GetData(sqlString);
        }
        /*
